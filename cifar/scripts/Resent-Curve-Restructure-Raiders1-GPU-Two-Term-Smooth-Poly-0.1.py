...
mom_val = 0.9
do_pred = True
log_dir = general_log_dir + "/noisy_lr_" + str(lr_val) + "_poly_0.1_2"
...
loss_list, g_norm_list, _, _ = train_rave_noisy(num_step, lr_val, mom_val, 
...
# plt.figure()
# plt.plot(g_norm_list)
# plt.title("lr * grad norm w.r.t \# iter")
# plt.grid()
# plt.show()


# ### run training process lr = 1.0
...
# mom_val = 0.9
# do_pred = True
# log_dir = general_log_dir + "/noisy_lr_" + str(lr_val)
# if not os.path.isdir(log_dir):
#     os.mkdir(log_dir)
